const Article = ({ isBrakingNews, article: { urlToImage, url, title, source }}) => {
  return (
    <a href={url} className="block relative bg-white rounded-lg shadow-sm ring-1 ring-black ring-opacity-5 h-full">
      <div className="relative bg-gray-100 pt-[50%]">
        ...
        {isBrakingNews && <div className="absolute bottom-0 z-10">
          <img src={'/Breaking-News-Transparent.png'} alt="breaking news" className="w-1/4" />
        </div>}
      </div>
